...
class MainTabBarController: UITabBarController
{
    ...
    {        
        viewControllers = [
            generateNavCon(with: DiscoverVC(collectionViewLayout: UICollectionViewFlowLayout()), for: "Discover", and: #imageLiteral(resourceName: "headphones")),
            generateNavCon(with: SongsSearchVC(), for: "Search", and: #imageLiteral(resourceName: "search"))
        ]
    }
    ...
    fileprivate func generateNavCon(with vc: UIViewController, for title: String, and image: UIImage) -> UIViewController
    {
        ...
        navVC.navigationBar.tintColor = .appPrimaryColor
        return navVC
    }
